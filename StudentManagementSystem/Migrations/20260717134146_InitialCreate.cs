        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    RegisterNumber = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Name = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StaffSubjects_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<int>(type: "int", nullable: false),
                    StaffSubjectId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Attendances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Attendances_StaffSubjects_StaffSubjectId",
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "DepartmentId", "Email", "Name", "PasswordHash", "Phone", "ProfilePhoto", "Role" },
                values: new object[] { 1, null, "admin@sms.com", "System Admin", "$2a$11$9NkBe5TelDjxJq2algegBuqjlzXwRHmrspBGGvymITSVkdZzXQTam", "9999999999", null, "Admin" });

            migrationBuilder.CreateIndex(
                name: "IX_Attendances_StaffSubjectId",
                table: "Attendances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffSubjects_DepartmentId",
                table: "StaffSubjects",
                column: "DepartmentId");
